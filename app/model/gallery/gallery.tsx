...
export default class Gallery {
  ...
  public static async getGalleryShapes(): Promise<Readonly<SierpinskiShape[]>> {
    ...
    galleryItems.push(new SierpinskiShape(10, "Sierpinski’s starry night", 214, null, 72, 0, "#ebc53d"));
    ...
    galleryItems.push(new SierpinskiShape(22, "Picaso’s triangle", 7, null, 359, 127, "#1e64ae"));
